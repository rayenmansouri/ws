    ...
    roles = [
        ...
        }, 
        {
          ...
          permissions: [
            ...
            // Coach Profile
            RoleService.formatPermission(ACTION_ENUM.VIEW, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.VIEW, RESOURCES_ENUM.TEENAGE),
            
            // full permission to teeage
            RoleService.formatPermission(ACTION_ENUM.VIEW, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.ADD, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.EDIT, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.DELETE, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.LIST, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.EXPORT, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.ASSIGN, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.UNASSIGN, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.ARCHIVE, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.UNARCHIVE, RESOURCES_ENUM.TEENAGE),
            RoleService.formatPermission(ACTION_ENUM.LIST, RESOURCES_ENUM.TEENAGE),
            //add for the coach
            RoleService.formatPermission(ACTION_ENUM.VIEW, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.ADD, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.EDIT, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.DELETE, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.LIST, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.EXPORT, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.ASSIGN, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.UNASSIGN, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.ARCHIVE, RESOURCES_ENUM.COACH),
            RoleService.formatPermission(ACTION_ENUM.UNARCHIVE, RESOURCES_ENUM.COACH),
            //ADD FOR ADMIN
            RoleService.formatPermission(ACTION_ENUM.VIEW, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.ADD, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.EDIT, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.DELETE, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.LIST, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.EXPORT, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.ASSIGN, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.UNASSIGN, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.ARCHIVE, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.UNARCHIVE, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.LIST, RESOURCES_ENUM.ADMIN),
            RoleService.formatPermission(ACTION_ENUM.EXPORT, RESOURCES_ENUM.ADMIN),
