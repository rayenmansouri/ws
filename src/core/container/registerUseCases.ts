...
import { UpdateBankTransferUseCase } from "../../feature/invoices/useCases/updateBankTransfer.usecase";
...
import { GetFinanceDashboardUseCase } from '../../feature/finance/useCases/GetFinanceDashboard.usecase';
...
import { AddTransactionUseCase } from '../../feature/finance/useCases/AddTransaction.usecase';
import { UpdateServiceUseCase } from '../../feature/finance/useCases/UpdateService.usecase';
import { AddServiceUseCase } from '../../feature/finance/useCases/AddService.usecase';
...
import { AddPostUseCase } from "../../feature/announcements/useCases/AddPost.usecase"
...
export const registerUseCases = (): void => {  
  ...
  container.bind("UpdateInvoiceUseCase").to(UpdateInvoiceUseCase);  
  container.bind("UpdateStudentPaymentConfigurationUseCase").to(UpdateStudentPaymentConfigurationUseCase);  
  container.bind("UpdateInvoiceRemindersUseCase").to(UpdateInvoiceRemindersUseCase);  
  container.bind("UnpaySplitUseCase").to(UnpaySplitUseCase);  
  container.bind("UnpayInvoiceUseCase").to(UnpayInvoiceUseCase);  
  container.bind("UnmergeInvoiceUseCase").to(UnmergeInvoiceUseCase);  
  container.bind("GetSearchInvoicesUseCase").to(GetSearchInvoicesUseCase);  
  container.bind("MergeInvoicesUseCase").to(MergeInvoicesUseCase);  
  container.bind("GetInvoicePdfDataUseCase").to(GetInvoicePdfDataUseCase);  
  container.bind("GetInvoiceDetailsUseCase").to(GetInvoiceDetailsUseCase);  
  container.bind("GetStudentInvoicesUseCase").to(GetStudentInvoicesUseCase);
  container.bind("AddInvoiceForStudentUseCase").to(AddInvoiceForStudentUseCase);  
  container.bind("GetFinanceDashboardUseCase").to(GetFinanceDashboardUseCase);  
  container.bind("UpdateTransactionsUseCase").to(UpdateTransactionsUseCase);  
  container.bind("DeleteTransactionsUseCase").to(DeleteTransactionsUseCase);  
  container.bind("AddTransactionUseCase").to(AddTransactionUseCase);  
  container.bind("UpdateServiceUseCase").to(UpdateServiceUseCase);  
  container.bind("AddServiceUseCase").to(AddServiceUseCase);  
  container.bind("DeleteServiceUseCase").to(DeleteServiceUseCase);  
  container.bind("GetStudentPaymentConfigurationUseCase").to(GetStudentPaymentConfigurationUseCase);  
  container.bind("DeleteInvoiceUseCase").to(DeleteInvoiceUseCase);  
  ...
  container.bind("GetReactionsOfCommentUseCase").to(GetReactionsOfCommentUseCase);  
  container.bind("GetReactionsOfPostUseCase").to(GetReactionsOfPostUseCase);  
  container.bind("TogglePinStatusOfPostUseCase").to(TogglePinStatusOfPostUseCase);  
  container.bind("ReactToCommentUseCase").to(ReactToCommentUseCase);  
  container.bind("ReactToPostUseCase").to(ReactToPostUseCase);  
  container.bind("AddReplyToCommentUseCase").to(AddReplyToCommentUseCase);  
  container.bind("AddCommentToPostUseCase").to(AddCommentToPostUseCase);  
  container.bind("DeletePostUseCase").to(DeletePostUseCase);  
  container.bind("UpdatePostUseCase").to(UpdatePostUseCase);  
  container.bind("GetUsersOfPostForMentionUseCase").to(GetUsersOfPostForMentionUseCase);  
  container.bind("AddPostUseCase").to(AddPostUseCase);  
  ...
  container.bind("ListPostsOfUserUseCase").to(ListPostsOfUserUseCase);
  container.bind("GetOnePostUseCase").to(GetOnePostUseCase);
  container.bind("GetOneCommentUseCase").to(GetOneCommentUseCase);
