...
export class InvoiceReminderEmail implements IEmail {
  ...
  constructor(invoice: {
    ...
    this.subject = "Rappel";
    this.message = `La facture n°${
      invoice.newId
    } est due pour paiement le${invoice.dueDate.toLocaleDateString()}`;
    this.html = this.generateHtml();
    this.invoice = invoice;
  }

  generateHtml(): string {
    const dueDateString = this.invoice.dueDate.toLocaleDateString("fr-FR", {
      weekday: "long",
      year: "numeric",
      month: "long",
      day: "numeric",
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
 <head>
  ...
  <title>Invoice reminder</title><!--[if (mso 16)]>
    <style type="text/css">
                 ...
                 <tr>
                  <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:510px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0"><img class="adapt-img" src="https://xjuauk.stripocdn.email/content/guids/CABINET_9d6b4e662399add9871c05eac2735a2f76a566b957e5426872efcb17b8f59d08/images/logo.png" alt="" width="362" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:1px;padding-bottom:45px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#2F2F2F;font-size:14px">your online school solution</p></td>
                     </tr>
                     <tr>
                      <td align="center" class="es-m-txt-c es-text-6827" style="padding:0;Margin:0;font-size:28px !important"><h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:36px !important;font-style:normal;font-weight:normal;line-height:36px !important;color:#000">Rappel</h1></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:32px;background-color:#ffffff" bgcolor="#ffffff">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:32px;padding-bottom:30px;padding-left:15px;font-size:0"><img class="img-9833" src="https://xjuauk.stripocdn.email/content/guids/CABINET_9d6b4e662399add9871c05eac2735a2f76a566b957e5426872efcb17b8f59d08/images/image_Xrl.png" alt="" width="153" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></td>
                     </tr>
                     <tr>
                      <td align="left" class="es-m-p5r es-m-p15l es-m-txt-l" style="padding:0;Margin:0;padding-right:25px;padding-left:25px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px !important;letter-spacing:0;color:#373737;font-size:16px !important">Nous tenons à vous rappeler que la facture n°&nbsp;<strong>#${
                        this.invoice.newId
                      }&nbsp;</strong>est due pour paiement le&nbsp;<strong>${dueDateString}</strong>. Nous attachons une grande importance à votre partenariat avec WebSchool et apprécions vivement votre attention à ce sujet.</p></td>
                     </tr>
                     <tr>
                      <td align="left" class="es-text-5151" style="padding:10px;Margin:0;font-size:16px !important"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;letter-spacing:0;color:#333333;font-size:16px !important;margin-left:40px"><strong style="line-height:200% !important">Numéro de facture: #${
                        this.invoice.newId
                      }<br>Montant: ${this.invoice.amount}${
      this.invoice.currency
    }<br>Date d'échéance: ${dueDateString}</strong></p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:30px;padding-bottom:30px;padding-left:15px"><!--[if mso]><a href="${frontUrl?.replace(
                        "SUBDOMAIN",
                        this.invoice.schoolSubdomain,
                      )}
                        /parent/payment/${this.invoice.newId}" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="${frontUrl?.replace(
    "SUBDOMAIN",
    this.invoice.schoolSubdomain,
  )}/parent/payment/${this.invoice.newId}"
                style="height:41px; v-text-anchor:middle; width:206px" arcsize="17%" stroke="f"  fillcolor="#0072c6">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Détails de la facture</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]--><!-- --><span class="es-button-border msohide" style="border-style:solid;border-color:#2CB543;background:#0072C6;border-width:0;display:inline-block;border-radius:7px;width:auto;mso-hide:all"><a href="${frontUrl?.replace(
      "SUBDOMAIN",
      this.invoice.schoolSubdomain,
    )}/parent/payment/${
      this.invoice.newId
    }" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 44px;display:inline-block;background:#0072C6;border-radius:7px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px !important;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #0072C6">Détails de la facture</a></span><!--<![endif]--></td>
                     </tr>
                     <tr>
                      <td align="left" class="es-m-p15l es-m-txt-l" height="25" style="padding:0;Margin:0;padding-right:25px;padding-left:25px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px !important;letter-spacing:0;color:#333333;font-size:16px !important">​Si vous avez déjà effectué le paiement, veuillez ignorer ce rappel.&nbsp;</p></td>
                     </tr>
                     <tr>
             ...
             <tr>
              <td align="left" bgcolor="#e4f8ff" style="padding:0;Margin:0;padding-right:20px;padding-left:20px;padding-top:20px;background-color:#e4f8ff">
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" bgcolor="#e4f8ff" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">​</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
