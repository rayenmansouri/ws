...
import { IBAnnualAveragesOfClassDTO } from "../../dto/ib/IBAnnualAveragesOfClass.dto";

@injectable()
export class GetIBAnnualAveragesOfClassUseCase {
  constructor(
  ...
  async execute(classNewId: string): Promise<IBAnnualAveragesOfClassDTO> {
    ...
    const studentAverages: IBAnnualAveragesOfClassDTO["studentAverages"] = [];
    for (const student of classDoc.students) {
      ...
      studentAverages.push({
        ...
        annualLevel: annualAverage.getLevel(),
      });
    }
