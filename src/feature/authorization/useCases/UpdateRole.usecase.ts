...
export class UpdateRoleUseCase {
  ...
  async execute(roleNewId: string, payload: UpdateRoleUseCaseRequest): Promise<void> {
    ...
    if (payload.permissions) RoleService.ensurePermissionsAreValid(payload.permissions);
