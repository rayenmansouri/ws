...
import { getUserModel } from "../../factory/models-factory";
...
export class DncParticipantRepository extends UserRepository{
    ...
    getModel(): Model<BaseUser> {
        ...
        return getUserModel<BaseUser>(this.connection, UserTypeEnum.PARTICIPANT, this.organization.organizationSystemType);
    }
